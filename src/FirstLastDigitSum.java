public class FirstLastDigitSum {
    public static void main(String[] args) {
        ...
        System.out.println(sumFirstAndLastDigit(3229));

        System.out.println(sumFirstAndLastDigitWithString(2));
        System.out.println(sumFirstAndLastDigitWithString(3229));
    }
    ...
    // Solution 2
    static  int sumFirstAndLastDigitWithString(int number) {
        if (number < 0) {
            return -1;
        }
        String num = String.valueOf(number);
        return Integer.parseInt(String.valueOf(num.charAt(0))) + Integer.parseInt(String.valueOf(num.charAt(num.length()-1)));
    }
